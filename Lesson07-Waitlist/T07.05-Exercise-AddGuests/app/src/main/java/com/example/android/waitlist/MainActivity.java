...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextGuestName = (EditText)findViewById(R.id.person_name_edit_text);
        editTextPartySize = (EditText)findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        if( editTextGuestName.getText().length() == 0 ||
            editTextPartySize.getText().length() == 0)
            return;
        ...
        try
        {
            partySize = Integer.parseInt(editTextPartySize.getText().toString());
        }
        catch (Exception ex)
        {
            return;
        ...
        addNewGuest(editTextGuestName.getText().toString(), partySize);
        ...
        editTextGuestName.getText().clear();
        editTextPartySize.getText().clear();
        editTextPartySize.clearFocus();
    }
    ...
    protected long addNewGuest(String name, int partySize)
    {
