...
public class MainActivity extends AppCompatActivity {
    ...
    final static String LIFECYCLE_CALLBACKS_TEXT_KEY = "callback";
    ...
    protected void onSaveInstanceState(Bundle outState)
    {
        ...
        String str = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, str);
    }
