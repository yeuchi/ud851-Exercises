...
public class MainActivity extends AppCompatActivity implements
    ...
    private IntentFilter mCharingIntentFilter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // and an IntentFilter
        mCharingIntentFilter = new IntentFilter();
        ...
        mCharingIntentFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mCharingIntentFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingReceiver, mCharingIntentFilter);
    }
    ...
    public void showCharging(boolean show)
    {
        if(show)
