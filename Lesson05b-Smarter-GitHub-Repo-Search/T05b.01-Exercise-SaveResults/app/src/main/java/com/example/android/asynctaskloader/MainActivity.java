...
public class MainActivity extends AppCompatActivity {
    ...
    protected final static String KEY_QUERY = "query";

    // TODO (2) Create a static final key to store the search's raw JSON
    protected  final static String KEY_RAW_JSON = "result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(null!=savedInstanceState)
        {
            ...
            String rawJsonResult = savedInstanceState.getString(KEY_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState)
    {
        ...
        outState.putString(KEY_QUERY, urlString);
        ...
        outState.putString(KEY_RAW_JSON, jsonString);
    }
}